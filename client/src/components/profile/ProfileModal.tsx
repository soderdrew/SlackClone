...
import { XMarkIcon, DocumentPlusIcon, TrashIcon, SparklesIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <>
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-xl bg-white p-6 shadow-xl transition-all">
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    {/* Chat with Avatar Button */}
                    {documents.length > 0 && documents.some(doc => doc.embedding_status === 'completed') && (
                      <div className="flex justify-center">
                        <Button
                        ...
                        >
                          ...
                          <span>Chat with your AI Avatar</span>
                        </Button>
                      </div>
                    )}
                  </div>
      ...
      <AvatarChatModal
        ...
        onClose={() => setIsAvatarChatOpen(false)}
        profile={profile}
      />
    </>
  );
